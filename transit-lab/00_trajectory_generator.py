...
def _(get_loaded_config, mo):
    ...
    sim_params = mo.ui.dictionary({
        ...
        "Mean trace proportion (0-1)": mo.ui.number(value=_cfg.get("Mean trace proportion (0-1)", 1.0), start=0, stop=1, step=0.05),
        "Stddev trace proportion": mo.ui.number(value=_cfg.get("Stddev trace proportion", 0.0), start=0, step=0.05),
